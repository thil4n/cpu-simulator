    ...
    return (
        <div className="w-full flex flex-col mb-1 relative">
            ...
            <div className="relative inline-block w-full" ref={dropdownRef}>
                <div
                    className={`w-full bg-primary text-secondary px-4 border border-slate-500 h-12 flex items-center justify-between cursor-pointer rounded-md ${
                        error ? "border-red-500" : ""
                    } ${inputClassName}`}
                    onClick={() => !readOnly && !disabled && setDropdownOpen(!isDropdownOpen)}
                >
