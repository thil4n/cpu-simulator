  ...
  return (
    <div className="w-full flex flex-col mb-1 relative">
      ...
      <div className="relative inline-block w-full" ref={dropdownRef}>
        ...
        {isDropdownOpen && (
          <div className="w-full flex flex-col max-h-48 overflow-y-auto absolute   border z-10">
            {optList.map((item: Option) => (
              <span
                className="px-3 py-3 bg-primary text-secondary hover:bg-secondary hover:text-white transition smooth border-b border-slate-200 cursor-pointer w-full"
                onClick={() => {
