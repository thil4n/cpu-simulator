...
const initialRegisters: CacheMem = {
...
export const RegisterProvider = ({ children }: { children: ReactNode }) => {
  const [registers, setRegisters] = useState<CacheMem>(initialRegisters);
  ...
  return (
    <RegisterContext.Provider value={{ registers, setRegister, gpRegisters, adgpRegisters }}>
      {children}
